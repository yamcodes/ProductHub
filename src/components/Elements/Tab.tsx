      ...
      className={({ selected }) =>
        twMerge(
          twJoin(
            ...
            selected &&
              'font-semibold after:absolute after:bottom-[calc(50%-25px)] after:left-0 after:z-10 after:h-[2px] after:w-[100%] after:rounded after:bg-gradient-to-r after:from-purple-500 after:to-pink-400',
          ),
          className,
        )
      }
