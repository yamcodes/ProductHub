"use strict";var n=require("repl"),c=require("./package-f376e6bd.cjs"),l=require("./index-bb73d2cd.cjs");require("url"),require("esbuild"),require("crypto"),require("fs"),require("path"),require("os"),console.log(`Welcome to tsx v${c.version} (Node.js ${process.version}).
